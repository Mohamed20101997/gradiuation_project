...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile mb4">
                <form class="form" action="{{route('admin.update', $admin->id)}}"
                      method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" placeholder="Enter the name" class="form-control" required value="{{ old('name',$admin->name) }}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email"  placeholder="Enter the email"  name="email" class="form-control" required value="{{ old('email',$admin->email) }}">
                                @error('email')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
